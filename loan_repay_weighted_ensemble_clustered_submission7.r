...
# - composed the weighted ensemble of trained models (SVM linear, RF, xgboost, adaboost, nnet) with parameters from cv
...
prediction1 <- (2*p1_1 + 3*p1_2 + 3*p1_3 + p1_4 + p1_5)/n.models 
prediction2 <- (2*p2_1 + 3*p2_2 + 3*p2_3 + p2_4 + p2_5)/n.models 
prediction3 <- (2*p3_1 + 3*p3_2 + 3*p3_3 + p3_4 + p3_5)/n.models 
prediction4 <- (2*p4_1 + 3*p4_2 + 3*p4_3 + p4_4 + p4_5)/n.models 
prediction5 <- (2*p5_1 + 3*p5_2 + 3*p5_3 + p5_4 + p5_5)/n.models 
